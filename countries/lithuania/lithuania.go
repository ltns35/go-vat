...
func doubleCheckCalculation(vat string, total int, rules countries.CountryRules) int {
...
func check9DigitVat(vat string, rules countries.CountryRules) bool {
...
func extractDigit12(vat string, total int, rules countries.CountryRules) int {
...
func doubleCheckCalculation12(vat string, total int, rules countries.CountryRules) int {
...
func check12DigitVat(vat string, rules countries.CountryRules) bool {
